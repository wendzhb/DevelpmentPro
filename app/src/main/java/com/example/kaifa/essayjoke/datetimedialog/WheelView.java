...
package com.example.kaifa.essayjoke.datetimedialog;
...
public class WheelView extends View {
	...
	/** 当前值与标签文本颜色 */
	private static int VALUE_TEXT_COLOR = 0x8FFE1100;
	...
	private void initData(Context context) {
		...
		VALUE_TEXT_COLOR = getResources().getColor(R.color.background_tab_pressed);
